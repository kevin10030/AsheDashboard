var Index = function () {
    return {
        init: function () {
            $.ajax({
                type: 'Get',
                url: '/device/getLocationNamesTask',
                success: function (xhr, status, response) {
                    //alert("get location(device) ok");
                ...
                error: function (jqXHR, exception) {
                    ...
                    //alert("get location(device) failed, "+msg);
                }
            });
        }
    };
...
$(document).ready(function () {
    // Device list table
    $dt_deviceList = $('#device-list').DataTable({
        "columnDefs": [{
            "searchable": false,
            "orderable": false,
            "targets": 0
